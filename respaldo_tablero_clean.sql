...
\restrict zGzlk0i1EnsXHYaDyX3YF6YU1yK28UJqIuwYAEcIuLrQOzHk53hLZMGkiX2gQp7
...
--
-- Name: auth_group; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_group OWNER TO redmine;

--
-- Name: auth_group_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_group_permissions OWNER TO redmine;

--
-- Name: auth_group_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_permission OWNER TO redmine;

--
-- Name: auth_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_user OWNER TO redmine;

--
-- Name: auth_user_groups; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_user_groups OWNER TO redmine;

--
-- Name: auth_user_groups_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.auth_user_user_permissions OWNER TO redmine;

--
-- Name: auth_user_user_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: descargas_registrocarga; Type: TABLE; Schema: public; Owner: redmine
--

CREATE TABLE public.descargas_registrocarga (
    id bigint NOT NULL,
    archivo character varying(100) NOT NULL,
    fecha_subida timestamp with time zone NOT NULL,
    registros_creados integer NOT NULL,
    estado_carga character varying(50) NOT NULL,
    usuario_id integer
);


ALTER TABLE public.descargas_registrocarga OWNER TO redmine;

--
-- Name: descargas_registrocarga_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--

ALTER TABLE public.descargas_registrocarga ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.descargas_registrocarga_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: django_admin_log; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.django_admin_log OWNER TO redmine;

--
-- Name: django_admin_log_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: django_content_type; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.django_content_type OWNER TO redmine;

--
-- Name: django_content_type_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: django_migrations; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.django_migrations OWNER TO redmine;

--
-- Name: django_migrations_id_seq; Type: SEQUENCE; Schema: public; Owner: redmine
--
...
--
-- Name: django_session; Type: TABLE; Schema: public; Owner: redmine
--
...
ALTER TABLE public.django_session OWNER TO redmine;
...
environment	production	2026-08-09 20:43:01.289796	2026-08-09 20:43:01.289804
\.
...
--
-- Data for Name: auth_group; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: auth_group_permissions; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: auth_permission; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
25	Can add registro carga	7	add_registrocarga
26	Can change registro carga	7	change_registrocarga
27	Can delete registro carga	7	delete_registrocarga
28	Can view registro carga	7	view_registrocarga
...
--
-- Data for Name: auth_user; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: auth_user_groups; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: auth_user_user_permissions; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: descargas_registrocarga; Type: TABLE DATA; Schema: public; Owner: redmine
--

COPY public.descargas_registrocarga (id, archivo, fecha_subida, registros_creados, estado_carga, usuario_id) FROM stdin;
\.


--
-- Data for Name: django_admin_log; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
--
-- Data for Name: django_content_type; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
6	sessions	session
7	descargas	registrocarga
8	proyectos	proyecto
\.


--
-- Data for Name: django_migrations; Type: TABLE DATA; Schema: public; Owner: redmine
--

COPY public.django_migrations (id, app, name, applied) FROM stdin;
1	contenttypes	0001_initial	2026-08-10 12:11:03.842908+00
2	auth	0001_initial	2026-08-10 12:11:20.021981+00
3	admin	0001_initial	2026-08-10 12:11:22.018949+00
4	admin	0002_logentry_remove_auto_add	2026-08-10 12:11:22.162894+00
5	admin	0003_logentry_add_action_flag_choices	2026-08-10 12:11:22.367286+00
6	contenttypes	0002_remove_content_type_name	2026-08-10 12:11:22.945888+00
7	auth	0002_alter_permission_name_max_length	2026-08-10 12:11:23.144995+00
8	auth	0003_alter_user_email_max_length	2026-08-10 12:11:23.573473+00
9	auth	0004_alter_user_username_opts	2026-08-10 12:11:23.684713+00
10	auth	0005_alter_user_last_login_null	2026-08-10 12:11:23.851456+00
11	auth	0006_require_contenttypes_0002	2026-08-10 12:11:23.904724+00
12	auth	0007_alter_validators_add_error_messages	2026-08-10 12:11:24.004402+00
13	auth	0008_alter_user_username_max_length	2026-08-10 12:11:24.733181+00
14	auth	0009_alter_user_last_name_max_length	2026-08-10 12:11:24.989203+00
15	auth	0010_alter_group_name_max_length	2026-08-10 12:11:25.151468+00
16	auth	0011_update_proxy_permissions	2026-08-10 12:11:25.314305+00
17	auth	0012_alter_user_first_name_max_length	2026-08-10 12:11:25.479369+00
18	descargas	0001_initial	2026-08-10 12:11:26.428267+00
19	sessions	0001_initial	2026-08-10 12:11:27.469839+00
20	proyectos	0001_initial	2026-08-10 12:34:48.377071+00
\.


--
-- Data for Name: django_session; Type: TABLE DATA; Schema: public; Owner: redmine
--
...
1	1	admin@dummy.invalid	t	t	2026-08-09 20:43:51.376026	2026-08-09 20:43:51.376026
\.
...
2				Anonymous users	f	1	\N		\N	2026-08-09 20:43:49.680323	2026-08-09 20:43:49.680323	GroupAnonymous		\N	f	\N	\N	\N	\N	f
3				Non member users	f	1	\N		\N	2026-08-09 20:43:49.934782	2026-08-09 20:43:49.934782	GroupNonMember		\N	f	\N	\N	\N	\N	f
1	admin	f491632e6deb44f3e3fe1d267a2d9c77e8911ffe	Redmine	Admin	t	1	\N		\N	2026-08-09 20:43:06.543655	2026-08-09 20:43:06.543655	User	all	32379c91e48094eced9b2ceb7bfbaacc	t	\N	\N	\N	\N	f
\.
...
--
-- Name: auth_group_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: descargas_registrocarga_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--

SELECT pg_catalog.setval('public.descargas_registrocarga_id_seq', 1, false);


--
-- Name: django_admin_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: django_content_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: django_migrations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group auth_group_name_key; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions auth_group_permissions_group_id_permission_id_0cd325b0_uniq; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions auth_group_permissions_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group auth_group_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission auth_permission_content_type_id_codename_01ab375a_uniq; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission auth_permission_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups auth_user_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups auth_user_groups_user_id_group_id_94350c0c_uniq; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user auth_user_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions auth_user_user_permissions_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions auth_user_user_permissions_user_id_permission_id_14a6b632_uniq; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user auth_user_username_key; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: descargas_registrocarga descargas_registrocarga_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--

ALTER TABLE ONLY public.descargas_registrocarga
    ADD CONSTRAINT descargas_registrocarga_pkey PRIMARY KEY (id);


--
-- Name: django_admin_log django_admin_log_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: django_content_type django_content_type_app_label_model_76bd3d3b_uniq; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: django_content_type django_content_type_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: django_migrations django_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: django_session django_session_pkey; Type: CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_name_a6ea08ec_like; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions_group_id_b120cbf9; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions_permission_id_84c5c92e; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission_content_type_id_2f476e4b; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups_group_id_97559544; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups_user_id_6a12ed8b; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions_permission_id_1fbb5f2c; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions_user_id_a95ead1b; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_username_6821ab7c_like; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: descargas_registrocarga_usuario_id_6ad10fee; Type: INDEX; Schema: public; Owner: redmine
--

CREATE INDEX descargas_registrocarga_usuario_id_6ad10fee ON public.descargas_registrocarga USING btree (usuario_id);


--
-- Name: django_admin_log_content_type_id_c4bce8eb; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: django_admin_log_user_id_c564eba6; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: django_session_expire_date_a5c62663; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: django_session_session_key_c0390e0f_like; Type: INDEX; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions auth_group_permissio_permission_id_84c5c92e_fk_auth_perm; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_group_permissions auth_group_permissions_group_id_b120cbf9_fk_auth_group_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_permission auth_permission_content_type_id_2f476e4b_fk_django_co; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups auth_user_groups_group_id_97559544_fk_auth_group_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_groups auth_user_groups_user_id_6a12ed8b_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions auth_user_user_permi_permission_id_1fbb5f2c_fk_auth_perm; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: auth_user_user_permissions auth_user_user_permissions_user_id_a95ead1b_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: descargas_registrocarga descargas_registrocarga_usuario_id_6ad10fee_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--

ALTER TABLE ONLY public.descargas_registrocarga
    ADD CONSTRAINT descargas_registrocarga_usuario_id_6ad10fee_fk_auth_user_id FOREIGN KEY (usuario_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: django_admin_log django_admin_log_content_type_id_c4bce8eb_fk_django_co; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
--
-- Name: django_admin_log django_admin_log_user_id_c564eba6_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: redmine
--
...
\unrestrict zGzlk0i1EnsXHYaDyX3YF6YU1yK28UJqIuwYAEcIuLrQOzHk53hLZMGkiX2gQp7
